...
def main():
    ...
    parser.add_argument('-m', '--master', metavar='MASTER', type=str, default='yarn',
                        help='Application master (default=yarn)')
    ...
    step_id = emr.add_spark_step(
        args.clusterid, args.stepname, args.deploy_mode, args.master, args.application, args.jars, args.pyfiles,
